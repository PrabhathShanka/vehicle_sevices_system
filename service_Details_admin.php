        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="admin_dash.php?record=serviseRecord" class="nav-link btn btn-primary py-4 px-lg-5 d-none d-lg-block">EXIT</a>
                        </div>
                </div>
...
// Setting
    ...
    if($conn->connect_error){
        ...
        <div class="wow fadeInUp" data-wow-delay="1s">
            ...
            <h2>Apoiment ID: <?php echo $appoimentID  ?></h2>
        </div> <br>
        <?php
        ...
        WHERE sr.appoimentID = '$appoimentID'";
