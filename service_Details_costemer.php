        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="index-AfterLogin.php#go-contact" class="nav-link btn btn-primary py-4 px-lg-5 d-none d-lg-block">EXIT</a>
                        </div>
                </div>
...
// Setting
    ...
    if($conn->connect_error){
        ...
        <div class="wow fadeInUp" data-wow-delay="1s">
            ...
            <h2>License plate number: <?php echo $licensePlate  ?></h2>
        </div> <br>
        <?php

        $sql = "SELECT s.serviceName, s.servicePrice,sr.date
        FROM servicerecord sr
        JOIN services s ON sr.serviceID = s.serviceID
        WHERE sr.licensePlate = '$licensePlate'";

        $data = $conn->query($sql);
        echo "<table border='1px' id='table'> <tr><th>Date</th><th>Service Name</th></tr>";
